        ...
        >
          {CATEGORIES.map((cat, i) => (
            ...
            >
              ...
              {cat.hero.type === "video" ? (
                <video
                  className="absolute inset-0 w-full h-full object-cover opacity-70 group-hover:opacity-95 transition-opacity duration-1200"
                  src={asset(cat.hero.src)}
                  autoPlay
                  muted
                  loop
                  playsInline
                ...
                <img
                  className="absolute inset-0 w-full h-full object-cover opacity-70 group-hover:opacity-100 transition-all duration-1200 group-hover:scale-[1.04]"
                  src={asset(cat.hero.src)}
                  alt={cat.hero.alt || cat.label}
                  loading="lazy"
                />
              )}
              ...
              {/* Number */}
              <span
                className="absolute top-6 right-6 text-white/20 font-light select-none z-10"
                style={{
                  fontFamily: "var(--font-cormorant), Georgia, serif",
                  fontSize: "5rem",
                  lineHeight: 1,
